                    ...
                    <form>
                        <div className='form-popup'>
                            ...
                            <input 
                                ...
                                required 
                                className={errors.includes('word') ? 'input-error' : ''}
                            />
                        </div>
                        <div className='form-popup'>
                            ...
                            <input 
                                ...
                                onChange={handleChange} 
                                required 
                                className={errors.includes('pronunciation') ? 'input-error' : ''}
                            />
                        </div>
                        <div className='form-popup'>
                            ...
                            <input 
                                name="k_word" 
                                value={formState.k_word} 
                                onChange={handleChange} 
                                required 
                                className={errors.includes('k_word') ? 'input-error' : ''}
                            />
                        </div>
                        <div className='form-popup'>
